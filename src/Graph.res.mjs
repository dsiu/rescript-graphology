...
import * as SVG from "./SVG.res.mjs";
import * as Layout from "./Layout.res.mjs";
import * as Traversal from "./Traversal.res.mjs";
import * as SimplePath from "./SimplePath.res.mjs";
import * as Graphology from "graphology";
import * as Caml_option from "rescript/lib/es6/caml_option.js";
import * as ShortestPath from "./ShortestPath.res.mjs";

function MakeGraph(C) {
  var Layout$1 = Layout.MakeLayout({});
  var ShortestPath$1 = ShortestPath.MakeShortestPath({});
  var SimplePath$1 = SimplePath.MakeSimplePath({});
  var SVG$1 = SVG.MakeSVG({});
  var Traversal$1 = Traversal.MakeTraversal({});
  return {
